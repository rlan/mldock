...
| Tag (OS-based python) | Comment | Dockerfile | Info |
| --------------------- | ------- | ---------- | ---- |
| `pytorch1.8.1` | CPU-only | [Dockerfile](pytorch1.8.1/Dockerfile) | [![](https://images.microbadger.com/badges/image/wqael/mldock:pytorch1.8.1.svg)](https://microbadger.com/images/wqael/mldock:pytorch1.8.1) |
| `pytorch1.8.1-cuda11.1.1` | Nvidia Driver >= 455.32 | [Dockerfile](pytorch1.8.1-cuda11.1.1/Dockerfile) | [![](https://images.microbadger.com/badges/image/wqael/mldock:pytorch1.8.1-cuda11.1.1.svg)](https://microbadger.com/images/wqael/mldock:pytorch1.8.1-cuda11.1.1) |
| `pytorch1.8.1-cuda10.2` | Nvidia Driver >= 440.33 | [Dockerfile](pytorch1.8.1-cuda10.2/Dockerfile) | [![](https://images.microbadger.com/badges/image/wqael/mldock:pytorch1.8.1-cuda10.2.svg)](https://microbadger.com/images/wqael/mldock:pytorch1.8.1-cuda10.2) |
